...
const TOMBSTONE_TOKEN =
  process.env.TOMBSTONE_TOKEN ?? process.env.TOMBSTONE_API_TOKEN;
    ...
    try {
      ...
      switch (name) {
        ...
        case "tombstone_blast_radius":
          result = await handleBlastRadius(
            args as Record<string, unknown>,
            apiUrl,
            apiToken,
          );
        ...
        case "tombstone_list_stale_flags":
          result = await handleListStaleFlags(
            args as Record<string, unknown>,
            apiUrl,
            apiToken,
          );
        ...
        case "tombstone_search_flags":
          result = await handleSearchFlags(
            args as Record<string, unknown>,
            apiUrl,
            apiToken,
          );
        ...
        case "tombstone_generate_cleanup_pr":
          result = await handleGenerateCleanupPR(
            args as Record<string, unknown>,
            apiUrl,
            apiToken,
          );
        ...
        case "tombstone_get_dependency_graph":
          result = await handleGetDependencyGraph(
            args as Record<string, unknown>,
            apiUrl,
            apiToken,
          );
        ...
        case "tombstone_propose_change_request":
          result = await handleProposeChangeRequest(
            args as Record<string, unknown>,
            apiUrl,
            apiToken,
          );
        ...
        case "tombstone_list_change_requests":
          result = await handleListChangeRequests(
            args as Record<string, unknown>,
            apiUrl,
            apiToken,
          );
